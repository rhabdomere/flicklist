...
function render() {
  ...
  $("#section-watchlist ul").empty();
    ...
    $("#browse-info").empty();  //important to reset this area; otherwise, title will be accumulating
  ...
  **/
  ...
  //populate title and overview column
  ...
  //add button
   $("#add-to-watchlist")
      .text("Add to Watchlist")
      .attr("class", "btn btn-primary")
       .unbind("click")    //very important to reset the click button; otherwise, all previous movies will be added
      .click(function() {
